...
const signals = [
  {
    ...
    description: 'All payments are processed securely through Stripe. We never store your card details.',
  },
  {
    icon: '🌽',
    title: 'Fresh every morning',
    description: 'Every order is cooked fresh the morning after you place it. Never reheated, never sitting out.',
  },
  {
    icon: '✅',
    title: 'Made to order',
    description: 'We only cook exactly what\'s been ordered. Your pre-payment guarantees your food is ready.',
  },
  {
    icon: '📬',
    title: 'Confirmation by email',
    description: 'You\'ll receive an order confirmation with pickup time and details right after payment.',
  },
]
