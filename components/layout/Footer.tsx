...
import { INSTAGRAM_URL, SITE_NAME, SITE_TAGLINE } from '@/lib/constants'

export default function Footer() {
  return (
    <footer className="bg-[#1A1A1A] text-white/80 py-12 px-4">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        <div>
          <p className="font-serif text-xl font-bold text-white mb-1" style={{ fontFamily: 'var(--font-lora)' }}>
            {SITE_NAME}
          </p>
